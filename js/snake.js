            ...
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    alert('Congratulations! You have beaten your previous high score, which was ' + highScore + '.');
                        ...
                        document.getElementById('high-score').innerHTML = 'Highscore: ' + me.snakeLength;
                }
}
            recordScore();
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "<p>Use the <strong>arrow keys</strong> on your keyboard to play the game.</p> " + fullScreenText;
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<p>You died :(.</p>";
        ...
        */
        ...
        document.getElementById(mode).addEventListener('click', function () {
            ...
            document.getElementById(mode).classList.add('button-selected');
        });
}
            getMode('Easy', 100);
            getMode('Medium', 75);
...
function getHighScore(){
    if(localStorage.jsSnakeHighScore){
        document.getElementById('high-score').innerHTML = 'Highscore: ' + localStorage.jsSnakeHighScore;
    }
}
getHighScore();
